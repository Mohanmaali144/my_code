...
class RectangleMen extends Frame implements WindowListener, ActionListener {
    ...
    public RectangleMen() {
        ...
        this.add(lb1);
        lb1.setBounds(45, 80, 120, 30);
        lb1.setBackground(Color.LIGHT_GRAY);

        num1 = new TextField();
        this.add(num1);
        num1.setBounds(165, 80, 120, 30);

        lb2 = new Label("Enter Width");
        this.add(lb2);
        lb2.setBounds(45, 130, 120, 30);
        lb2.setBackground(Color.LIGHT_GRAY);
        num2 = new TextField();
        this.add(num2);
        num2.setBounds(165, 130, 120, 30);
        ...
        this.add(diagonal);
        diagonal.setBounds(165, 180, 120, 30);
        diagonal.addActionListener(this);

        clearbtn = new Button("clear");
        this.add(clearbtn);
        clearbtn.setBounds(100, 300, 100, 30);
        clearbtn.setBackground(Color.pink);
        clearbtn.addActionListener(this);

        lb2 = new Label("Ans");
        this.add(lb2);
        lb2.setBounds(45, 250, 100, 30);
        lb2.setBackground(Color.yellow);

        ans = new Label();
        ans.setBounds(165, 250, 120, 30);
        this.add(ans);
