...
class Vaccin
{
	public static void main(String[]args)                                  
	{
		...
		System.out.println("\t|  Unique Health ID (UHID)                        80-1110-0541-1001");
		System.out.println("\t|  Beneficiary Reference ID                       9610856646667321\n\t|\n\t|");
		System.out.println("\t|  Vaccination Details\n\t|");
		System.out.println("\t|  Vaccination Name                               COVISHIELD");
		System.out.println("\t|  Date of 1st Dose                               15 june 2021");
